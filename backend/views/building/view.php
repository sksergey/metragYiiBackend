...
<div class="col-xs-12 col-sm-3 col-md-3 ">
    ...
    <?= $form->field($model, 'developer_id')->textInput(['readonly' => 'true',
        'value' => Developer::findOne(['developer_id' => $model->developer_id])->name ? Developer::findOne(['developer_id' => $model->developer_id])->name : ""])->label('Застройщик'); ?>
