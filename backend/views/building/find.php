...
<?
$this->title = Yii::t('app', 'Building Search');
    ...
    <div class="main-content">
        ...
        <div class="main-content-header">
            ...
            <div class="pull-right">
                ...
                <a href="<?= Url::base(true);?>/building/search" class="btn btn-default">Сбросить</a>
            </div>
            <div class="pull-right">
        ...
        <div class="container-fluid">
            ...
            <div class="col-xs-6 col-sm-2 col-md-2">
                ...
                echo $form->field($model, 'type_object_id',[
                    ...
                    TypeObject::find()->select(['name', 'type_object_id'])->where(['type_realty_id'=>'3'])->indexBy('type_object_id')->column(),
