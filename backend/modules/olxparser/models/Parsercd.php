...
/**
 * This is the model class for table "new_parser_olx_parsercd".
 *
 * @property integer $id
...
class Parsercd extends \yii\db\ActiveRecord
{
    ...
    {
        return 'new_parser_olx_parsercd';
    }
    ...
    {
        return [
            [['advert_id', 'silka', 'path', 'date', 'type_object_id', 'advert_from', 'type', 'type_flat', 'count_room', 'floor', 'floor_all', 'total_area', 'floor_area', 'kitchen_area', 'price', 'phone', 'status', 'note', 'kolfoto', 'image', 'view'], 'required'],
            [['advert_id', 'type_object_id', 'count_room', 'floor', 'floor_all', 'total_area', 'floor_area', 'kitchen_area', 'kolfoto'], 'integer'],
            [['silka', 'path', 'phone', 'status', 'note', 'image', 'view'], 'string'],
